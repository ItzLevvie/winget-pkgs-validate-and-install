...
if "%NUMBER%" == "" goto :1
cd "%USERPROFILE%/Desktop/winget-pkgs"
...
if "%PATH%" == "" goto :2
winget validate --manifest "%USERPROFILE%/Desktop/winget-pkgs/%PATH%"
winget install --manifest "%USERPROFILE%/Desktop/winget-pkgs/%PATH%"
