# This script requires you to run: Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope LocalMachine -Force ; & ".\Community Moderators - 2025-08-28 - development.ps1"
...
function Initialize-Repository {
    ...
    if (-not($REPOSITORY_DIRECTORY_GIT_FOLDER)) {
        ...
        git clone --no-checkout --sparse --branch master --shallow-since=2025-07-01 --single-branch --no-tags https://github.com/microsoft/winget-pkgs $REPOSITORY_DIRECTORY
